...
export default function HomePackageCategoryScreen() {
  ...
  return (
    <View style={[s.screen, { backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        <Text style={[s.topBarTitle, { color: theme.colors.text }]}>{selectedCategory.title}</Text>
        ...
        {filteredPackages.length === 0 ? (
          ...
          filteredPackages.map((pkg) => (
            <Pressable
              ...
              onPress={() =>
                router.push({
                  pathname: "/(parent)/home/_screens/package-detail",
